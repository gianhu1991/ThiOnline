        ...
        {selectedGroup ? (
          loadingDetail ? (
            <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* Skeleton loading cho 4 card */}
              {/* Thành viên skeleton */}
              <div className="bg-gradient-to-br from-blue-50 to-white border-l-4 border-blue-500 rounded-lg shadow-md p-5 animate-pulse">
              ...
              {/* Video skeleton */}
              <div className="bg-gradient-to-br from-green-50 to-white border-l-4 border-green-500 rounded-lg shadow-md p-5 animate-pulse">
                <div className="flex items-center gap-2 mb-3">
                  <div className="w-10 h-10 bg-green-200 rounded-lg"></div>
                  <div className="h-5 w-16 bg-green-200 rounded"></div>
                </div>
                <div className="h-12 bg-gray-200 rounded-lg mb-3"></div>
              ...
              {/* Tài liệu skeleton */}
              <div className="bg-gradient-to-br from-purple-50 to-white border-l-4 border-purple-500 rounded-lg shadow-md p-5 animate-pulse">
                <div className="flex items-center gap-2 mb-3">
              ...
              {/* Bài thi skeleton */}
              <div className="bg-gradient-to-br from-orange-50 to-white border-l-4 border-orange-500 rounded-lg shadow-md p-5 animate-pulse">
                <div className="flex items-center gap-2 mb-3">
                  <div className="w-10 h-10 bg-orange-200 rounded-lg"></div>
                  <div className="h-5 w-16 bg-orange-200 rounded"></div>
                </div>
                <div className="h-12 bg-gray-200 rounded-lg mb-3"></div>
                <div className="h-10 bg-orange-200 rounded-lg"></div>
              </div>
            </div>
          ) : (
            <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-4">
