      ...
      {loading ? (
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {videos.map((video) => {
            ...
            return (
              <div key={video.id} className="card hover:shadow-xl transition-shadow flex flex-col">
                <Link href={`/videos/${video.id}`} className="flex-1 flex flex-col">
                  ...
                  <div className="p-4 flex-1 flex flex-col">
                    <h3 className="text-lg font-bold mb-2 text-gray-900 line-clamp-2">{video.title}</h3>
                    {video.description && (
