...
-- Tạo bảng UserGroup (Nhóm người dùng)
...
-- Tạo bảng UserGroupMember (Thành viên trong nhóm)
...
-- Tạo bảng VideoGroup (Gán video cho nhóm)
...
-- Tạo bảng DocumentGroup (Gán tài liệu cho nhóm)
